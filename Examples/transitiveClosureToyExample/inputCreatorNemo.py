...
def main(*args):
    ...
    if format == "tree":
        ...
        with open(problemName + ".ograph.json", "w") as f:
            json.dump({"graph": {"edges": graph}, "program": program}, f, ensure_ascii=False, indent=4)

if __name__ == "__main__":
    import sys
    #main(*sys.argv[1:])
    main("./", "transitiveClosureToyExample.rls", "-t")
    main("./", "transitiveClosureToyExample.rls", "-g")
    main("./", "transitiveClosureToyExample.rls", "-o")
