...
if __name__ == "__main__":
    import sys
    #main(*sys.argv[1:])
    # main("./", "tc.rls", "-t", "TL(0,1000)", "TL(0,999)", "TL(1,1000)", "TR(0,1000)", "TR(0,999)", "TR(1,1000)", "T(0,1000)", "T(0,999)", "T(1,1000)")
    # main("./", "tc.rls", "-g", "TL(0,1000)", "TL(0,999)", "TL(1,1000)", "TR(0,1000)", "TR(0,999)", "TR(1,1000)", "T(0,1000)", "T(0,999)", "T(1,1000)")
    # main("./", "tc.rls", "-t", "T(0,1000)", "T(0,999)", "T(1,1000)")
    # main("./", "tc.rls", "-g", "T(0,1000)", "T(0,999)", "T(1,1000)")
    main("./", "tc.rls", "-t")
    main("./", "tc.rls", "-g")
