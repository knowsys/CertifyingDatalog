...
- Build the `nmo` binary from <https://github.com/knowsys/nemo>. For the latest experiments, we used <https://github.com/knowsys/nemo/releases/tag/v0.7.1>. Run `cargo b -r`. The binary can be found in `/path/to/nemo/target/release/nmo`.
